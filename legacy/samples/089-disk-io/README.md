...
## このサンプルで体験すること
短い実験で「Disk I/Oの読み書き量を処理前後で観察する」を体験し、操作前後の状態やログの差を確認する。
...
## 最小コード
```powershell
Get-Counter '\PhysicalDisk(_Total)\Disk Read Bytes/sec','\PhysicalDisk(_Total)\Disk Write Bytes/sec' -SampleInterval 1 -MaxSamples 6
```
