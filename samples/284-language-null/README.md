...
## このサンプルで体験すること
短い実験で「Null・Empty・Nothing・$nullの違いを体験する」を体験し、操作前後の状態やログの差を確認する。
...
```vb
Option Explicit
Public Sub Demo():Dim v As Variant,o As Object:Debug.Print IsEmpty(v):Debug.Print o Is Nothing:Debug.Print IsNull(Null):End Sub
```
