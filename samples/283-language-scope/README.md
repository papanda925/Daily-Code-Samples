...
## このサンプルで体験すること
短い実験で「ローカル変数とグローバル変数のScopeを比べる」を体験し、操作前後の状態やログの差を確認する。
...
Public Sub Demo():Dim localValue As String:moduleValue="module":localValue="local":Debug.Print moduleValue,localValue:End Sub
```
