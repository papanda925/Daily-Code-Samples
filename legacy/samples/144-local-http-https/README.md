...
## このサンプルで体験すること
短い実験で「localhostでHTTPとHTTPSの見える情報の違いを比べる」を体験し、操作前後の状態やログの差を確認する。
...
## 最小コード
```powershell
curl.exe -I -v http://example.com 2>&1|Select -First 20
"--- HTTPS ---"
curl.exe -I -v https://example.com 2>&1|Select -First 35
```
