...
## このサンプルで体験すること
短い実験で「型って何？ String・Integer・Dateを比べる」を体験し、操作前後の状態やログの差を確認する。
...
### PowerShell
```powershell
[int]$n=10;[string]$s='10';[datetime]$d=Get-Date;$n.GetType().Name;$s.GetType().Name;$d.GetType().Name
```

### VBA
```vb
Option Explicit
Public Sub Demo():Dim n As Long,s As String,d As Date:n=10:s="10":d=Now:Debug.Print TypeName(n),TypeName(s),TypeName(d):End Sub
```
