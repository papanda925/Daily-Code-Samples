...
## このサンプルで体験すること
短い実験で「戻り値はどう返る？ VBA FunctionとPowerShell Pipelineを比べる」を体験し、操作前後の状態やログの差を確認する。
...
```vb
Option Explicit
Public Function DoubleValue(ByVal x As Long) As Long:DoubleValue=x*2:End Function
```
