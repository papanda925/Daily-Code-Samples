...
## このサンプルで体験すること
短い実験で「PowerShellから.NET Classを直接newして使う」を体験し、操作前後の状態やログの差を確認する。
...
## 最小コード
```powershell
$sb=[Text.StringBuilder]::new();[void]$sb.Append('Hello');[void]$sb.Append(' .NET');$sb.ToString();$d=[Collections.Generic.Dictionary[string,int]]::new();$d['A']=1;$d
```
