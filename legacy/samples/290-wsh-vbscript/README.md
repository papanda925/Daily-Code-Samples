...
## このサンプルで体験すること
短い実験で「Windows Script HostとVBScriptの現在位置を知る」を体験し、操作前後の状態やログの差を確認する。
...
## 最小コード
```powershell
Get-Command wscript.exe,cscript.exe|Select Name,Source
"VBScript利用可否はWindows版/オプション機能で変わる"
```
