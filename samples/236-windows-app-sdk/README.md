...
## このサンプルで体験すること
短い実験で「Visual StudioなしでWindows App SDK／WinUI 3の最小構成を理解する」を体験し、操作前後の状態やログの差を確認する。
...
```powershell
dotnet --info
Get-AppxPackage Microsoft.WindowsAppRuntime* -EA 0|Select Name,Version,Architecture
"WinUI 3はWindows App SDK上のGUI。WPF/WinFormsやWinRTとの層の違いを確認"
```
