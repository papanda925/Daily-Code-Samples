...
## このサンプルで体験すること
短い実験で「Named PipeとTCP Socketの違いを同じ文字列送信で比べる」を体験し、操作前後の状態やログの差を確認する。
...
## 最小コード
```powershell
"Named Pipe: IPC / TCP Socket: network"
[IO.Pipes.NamedPipeServerStream].FullName
[Net.Sockets.TcpListener].FullName
```
